...
interface FormState { fullName:string; regNumber:string; phone:string; email:string; gender:string; course:string; yearOfStudy:string; moveInDate:string; }
const initialForm: FormState = { fullName:"", regNumber:"", phone:"", email:"", gender:"", course:"", yearOfStudy:"", moveInDate:"2026-09-01" };
...
export default function Booking(){
  ...
  const validateStep2=()=>{
    ...
    if(!/^[A-Za-z]{3,4}\/\d{3,5}\/\d{2,4}$/.test(form.regNumber.trim())&&form.regNumber.trim().length<4)e.regNumber="Enter a valid registration number.";
